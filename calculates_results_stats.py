...
def calculates_results_stats(results_dic):
    ...
    notdogs = 0
    matches = 0
    #iterate through existing dic, compute stats
    ...
    results_stats_dic["pct_match"] = matches
    results_stats_dic["pct_correct_dogs"] = correct
    results_stats_dic["pct_correct_breed"] = breeds
    results_stats_dic["pct_correct_notdogs"] = notdogs
